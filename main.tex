...
$X_1=-3, C=0.3$ SN for the first season of field \#290 (the one of
...
\begin{figure*}[t]
\begin{center}
\subfigure[$g$]{\includegraphics[width=0.48\linewidth]{m5_cadence_limits_wide_g_all.pdf}}
\subfigure[$r$]{\includegraphics[width=0.48\linewidth]{m5_cadence_limits_wide_r_all.pdf}}\\
\subfigure[$i$]{\includegraphics[width=0.48\linewidth]{m5_cadence_limits_wide_i_all.pdf}}
\subfigure[$z$]{\includegraphics[width=0.48\linewidth]{m5_cadence_limits_wide_z_all.pdf}}
...
\begin{figure*}[t]
  \begin{center}
    ...
    \caption{Colored lines: the SNR of the estimated amplitude of a
      $[X_1=-3, C=0.3]$ SN~Ia at a redshift $z = 0.4$ as a function of
      peak MJD, computed for the \code{Minion\_1016} cadence and depth
