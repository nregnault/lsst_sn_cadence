...
\subfigure[\code{SMTN-002} -- 1200-s DDF visits]{\includegraphics[width=0.49\linewidth]{sigc_lsstpg_ddf_1200.pdf}}
\subfigure[\code{SMTN-002} -- 600-s visits]{\includegraphics[width=0.49\linewidth]{snr_lsstpg_ddf_600.pdf}}
\subfigure[\code{SMTN-002} -- 1200-s DDF visits]{\includegraphics[width=0.49\linewidth]{snr_lsstpg_ddf_1200.pdf}}
\end{center}
...
\begin{figure*}
\begin{center}
\subfigure[\code{SMTN-002} -- 1200-s -- 2 day cadence]{\includegraphics[width=0.49\linewidth]{sigc_lsstpg_ddf_1200_cad2.pdf}}
\subfigure[\code{LSE-40} -- 1200-s -- 2 day cadence]{\includegraphics[width=0.49\linewidth]{sigc_lsst_ddf_1200_cad2.pdf}}
\subfigure[\code{SMTN-002} -- 1200-s -- 2 day cadence]{\includegraphics[width=0.49\linewidth]{snr_lsstpg_ddf_1200_cad2.pdf}}
\subfigure[\code{LSE-40} -- 1200-s -- 2 day cadence]{\includegraphics[width=0.49\linewidth]{snr_lsst_ddf_1200_cad2.pdf}}
\end{center}
...
\hline
              & $r$ & $i$ & $z$ & $y$ \\
\hline 
$T_{exp}$      & \multicolumn{4}{c}{1200-s} \\
$m_{5\sigma}$  & 26.36    & 25.87    &  25.28    &  24.40   \\
cadence       &  \multicolumn{4}{c}{2 days} \\
Target amplitude SNR & $>20$ & $>20$ & $>20$ & $>10$ \\
\hline
\end{tabular}
\end{center}
\end{table*}
...
\hline 
$T_{exp}$      & 30       &   60    &  60        & 30       \\
$m_{5\sigma}$  &  24.77   &  24.29   &  23.82    &  23.24   \\
cadence       &  \multicolumn{4}{c}{4 days} \\
Target amplitude SNR & $>20$ & $>20$ & $>20$ & $>15$ \\
\hline
\end{tabular}
\end{center}
\end{table*}
