...
% With three bands, we reach $\sigma_c < 0.03$ by requiring a SNR of 20
...
We have produced the similar plots for the main (shallow, wide) survey
(no recadencing). Figure \ref{fig:m5_cadence_limits_wide} shows the
cadence {\em vs.}  $m_{5\sigma}$ plane for the wide survey.  The red
stars indicates the depth to attain, with a 4-day observer-frame
cadence (22.9, 22.5, 22.3 in $r, i, $ and $z$ respectively).
