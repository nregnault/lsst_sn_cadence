...
\subfigure[\code{SMTN-002} -- deeper]{\includegraphics[width=0.49\linewidth]{sigc_lsstpg_wide_60.pdf}}
\subfigure[\code{SMTN-002} -- standard visits]{\includegraphics[width=0.49\linewidth]{snr_lsstpg_wide_30.pdf}}
\subfigure[\code{SMTN-002} -- deeper]{\includegraphics[width=0.49\linewidth]{snr_lsstpg_wide_60.pdf}}
\end{center}
\caption{Upper panels: $\sigma_C$ (shot noise only) obtained on the
...
\code{OpSim v3.3.5} \cite{1991PASP..103.1033K} and a new sky model that will be
available for the next \code{OpSim} versions. 
...
\begin{figure*}[t]
\begin{center}
\subfigure[$u$]{\includegraphics[width=0.48\linewidth]{Cadence_Hist_u.pdf}}
\subfigure[$g$]{\includegraphics[width=0.48\linewidth]{Cadence_Hist_g.pdf}}
\subfigure[$r$]{\includegraphics[width=0.48\linewidth]{Cadence_Hist_r.pdf}}
\subfigure[$i$]{\includegraphics[width=0.48\linewidth]{Cadence_Hist_i.pdf}}
\subfigure[$z$]{\includegraphics[width=0.48\linewidth]{Cadence_Hist_z.pdf}}
\subfigure[$y$]{\includegraphics[width=0.48\linewidth]{Cadence_Hist_y.pdf}}
...
The red crosses indicate what we get from \code{Minion\_1016} and the
...
\begin{figure*}[t]
\begin{center}
\subfigure[$g$]{\includegraphics[width=0.48\linewidth]{m5_cadence_limits_rolling_r.pdf}}
\subfigure[$r$]{\includegraphics[width=0.48\linewidth]{m5_cadence_limits_rolling_i.pdf}}\\
\subfigure[$i$]{\includegraphics[width=0.48\linewidth]{m5_cadence_limits_rolling_z.pdf}}
\subfigure[$z$]{\includegraphics[width=0.48\linewidth]{m5_cadence_limits_rolling_y.pdf}}
\caption{The cadence {\em vs.} depth requirements for the Wide survey,
...
LSE-40.  The current version \code{OpSim} relies on SMTN-002. An we therefore
